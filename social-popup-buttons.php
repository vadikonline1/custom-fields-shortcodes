...
class SFB_List_Table extends WP_List_Table {
    ...
    function get_bulk_actions(){
        return [
            ...
            // REMOVED: 'update_order' => 'Update Order'
        ];
    }
...
// =========================
// ENHANCED ADD/EDIT FORM - CU ORDER DOAR LA EDIT
// =========================
function sfb_add_edit_form(){
    ...
    if(isset($_POST['sfb_save_button'])){
        ...
        if($editing){
            ...
            $id = uniqid('sfb_');
            // Get max order for new item - se adaugă automat la sfârșit
            $max_order = 0;
            foreach($buttons as $b) {
            ...
            $buttons[] = [
                ...
                'icon_type' => $icon_type,
                'order' => $max_order + 1 // Se adaugă automat la sfârșit
            ];
        }
